...
abstract class AppColor {
  ...
  static const Color lightCard = Color.fromARGB(106, 250, 250, 250);
  ...
  static const Color colorTextLight = Colors.black;
  static const Color colorTextdark = Colors.white;
  static const Color darkCard = Color.fromARGB(255, 13, 6, 37);
}
